...
//	String ReportLocation =  System.getProperty("user.dir")+ resultpath + "/";
	...
	private static String getResultPath() {
		...
		resultpath = "reports";// new SimpleDateFormat("yyyy-MM-dd hh-mm.ss").format(new Date());
...
//		System.out.println(ReportLocation + "  ReportLocation");
		reports = new ExtentReports("./report/result.html");
